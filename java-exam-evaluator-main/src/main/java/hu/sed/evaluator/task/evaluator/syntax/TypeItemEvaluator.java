...
import static hu.sed.evaluator.task.evaluator.syntax.SyntaxElement.INTERFACES;
import static hu.sed.evaluator.task.evaluator.syntax.SyntaxElement.PARENT_CLASS;
